...
int main(int argc, char** argv) {
    ...
    auto distributedStart = std::chrono::high_resolution_clock::now();
    Matrix subResult = multiply(localA, B, sendRowCounts[rank]);
    auto distributedEnd = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double, std::milli> distributedDuration = distributedEnd - distributedStart;
